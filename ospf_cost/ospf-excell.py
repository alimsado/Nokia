...
wb = Workbook()
ws = wb.active
ws.append(["Router IP", "System Name", "Interface", "Cfg Metric"])
            ...
            for interface in interfaces:
                ...
                if match:
                    ...
                    if cfg_metric_match:
                        ...
                        ws.append([router['ip'], router['system_name'], interface_name.strip(), cfg_metric.strip()])

            # Close the SSH session
            ssh_session.disconnect()

        except Exception as e:
            print(f"An error occurred while retrieving OSPF details for {router['system_name']}: {str(e)}")

except Exception as e:
    print("An error occurred:", str(e))

# Save the Excel file
wb.save("ospf_interface_details.xlsx")
