...
if __name__ == "__main__":
    try:
        ...
        # Generate PDF with current date in filename
        today = date.today().strftime("%Y-%m-%d")
        pdf_filename = f"ospf_interface_details_{today}.pdf"
        generate_pdf(all_data, pdf_filename)
